...
I was able to get Monocular SLAM working, but without IMU data, I cannot estimate the drone’s true position within the environment. The synchronization of collecting IMU data and camera sensor data was a more difficult task than expected, and thus I did not accomplish this goal before the deadline. Thus, a future iteration for this project would be to successfully utilize a VI-SLAM algorithm  for navigation instead of GPS.
